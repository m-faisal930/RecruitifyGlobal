...
const handleSubmit = async (e) => {
  ...
  try {
    ...
    // formDataToSend.append('preferredTimezone', formData.preferredTimezone);
    // formDataToSend.append('howDidYouHear', formData.howDidYouHear);
    // formDataToSend.append('termsAgreed', formData.termsAgreed.toString());
              ...
              <div className="p-6 md:p-8">
                ...
                <form onSubmit={handleSubmit} className="space-y-6">
                  <div className="grid md:grid-cols-2 gap-6">
                    ...
                    <div>
                      <label className="block text-sm font-medium text-gray-700 mb-1">
                        Total Years of Experience as a Recruiter *
                      </label>
                      <select
                    ...
                    <div>
                      ...
                      >
                        ...
                        <option value="EST (Eastern Time)">
                          EST (Eastern Time)
                        </option>
                        <option value="CST (Central Time)">
                          CST (Central Time)
                        </option>
                        <option value="PST (Pacific Time)">
                          PST (Pacific Time)
                        </option>
                    ...
                    <div className="md:col-span-2">
                      <label className="block text-sm font-medium text-gray-700 mb-1">
                        How did you learn about Recruitify Global? *
                      </label>
                      <select
                        name="howDidYouHear"
                    ...
                    <div className="md:col-span-2">
                      ...
                      <input
                        ...
                        onChange={(e) =>
                          setFormData((prev) => ({
                            ...prev,
                            cv: e.target.files[0], // Store the actual File object
                          }))
                        }
                        required
                        accept=".pdf"
